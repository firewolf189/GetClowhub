...
do {
    ...
    let sharedPath = "OpenClawInstaller/Views/Shared/ShimmeringStatusText.swift"
    ...
    let workStatus = try read("OpenClawInstaller/Views/Dashboard/WorkStatusHeader.swift")
    ...
    let pluginsView = try read("OpenClawInstaller/Views/Dashboard/Plugins/PluginsTabView.swift")
