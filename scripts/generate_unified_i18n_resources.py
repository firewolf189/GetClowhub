...
COMMON = {
    ...
    "repair.action.safeRepair": "Repair Gateway Safely",
    "repair.emergency.confirm.message": "Safe repair could not complete. Emergency repair force-stops gateway processes and may interrupt running tasks. Configuration and chat history are preserved.",
    "repair.emergency.confirm.proceed": "Run Emergency Repair",
    "repair.emergency.confirm.title": "Run emergency repair?",
    "repair.safe.coalesced": "A safe restart is already pending (%lld active item(s)). OpenClaw will restart after they finish.",
    "repair.safe.configurationFailed": "The required settings could not be safely written and verified. No restart was requested.",
    "repair.safe.confirm.message": "This sets private chats to per-channel-and-person isolation. If work is active, OpenClaw waits until it finishes before restarting.",
    "repair.safe.confirm.proceed": "Start Safe Repair",
    "repair.safe.confirm.title": "Repair DingTalk message handling?",
    "repair.safe.deferred": "Configuration repaired. %lld active item(s) are still running; OpenClaw will restart automatically after they finish.",
    "repair.safe.restartFailed": "Configuration was repaired, but OpenClaw could not accept the safe restart request.",
    "repair.safe.scheduled": "Configuration repaired. The gateway restarted safely and DingTalk is connected.",
    "repair.safe.scheduledDingTalkPending": "Configuration repaired and the gateway restarted safely. DingTalk has not reconnected yet; check channel status shortly.",
    "repair.safe.upgradeRequired": "Installed OpenClaw %@ does not support task-safe repair. Upgrade to the bundled %@ core and try again; the client will not modify the core.",
    "repair.safe.verificationFailed": "The safe restart was requested, but gateway recovery or the repaired settings could not be verified.",
    "repair.step.deferralFailed": "Could not set safe restart to wait indefinitely for active work",
    "repair.step.deferralRepaired": "Safe restart now waits indefinitely for active work",
    "repair.step.dmScopeFailed": "Could not set private chat isolation to per-channel-peer",
    "repair.step.dmScopeRepaired": "Private chat isolation is set to per-channel-peer",
    ...
    "dashboard.session.action.unarchive": "Unarchive",
    "dashboard.session.action.confirmDelete": "Confirm delete",
    "dashboard.session.newChat": "New chat",
    "dashboard.session.showMore": "Show %@ more…",
    "dashboard.session.filter.active": "Active",
    "dashboard.session.filter.archived": "Archived",
    "dashboard.session.filter.all": "All",
    "dashboard.session.filter.tooltip": "Filter chats",
    "dashboard.session.empty.active": "No sessions yet",
    "dashboard.session.empty.archived": "No archived chats",
    "dashboard.session.empty.all": "No sessions yet",
    "dashboard.session.row.messageCount": "%lld messages",
    ...
    "dashboard.cron.sheet.session.conversation": "Conversation",
    "dashboard.cron.sheet.sessionHelp": "Conversation: one stable chat thread for every run. Isolated: a throwaway session each run. Main: reuse the agent's main session.",
    "dashboard.cron.openChat": "Open chat",
    "dashboard.cron.sessionTitle": "Cron: %@",
...
COMMON_ZH_HANS = {
    ...
    "repair.action.safeRepair": "安全修复网关",
    "repair.emergency.confirm.message": "安全修复未能完成。应急修复会强制结束网关进程，可能中断正在运行的任务；配置和聊天记录会保留。",
    "repair.emergency.confirm.proceed": "执行应急修复",
    "repair.emergency.confirm.title": "执行应急修复？",
    "repair.safe.coalesced": "已有安全重启请求正在等待（当前 %lld 个活动任务）。任务结束后 OpenClaw 会自动重启。",
    "repair.safe.configurationFailed": "无法安全写入并复核所需配置，尚未请求重启。",
    "repair.safe.confirm.message": "将钉钉私聊改为按渠道和联系人隔离。若存在活动任务，OpenClaw 会等任务结束后再重启。",
    "repair.safe.confirm.proceed": "开始安全修复",
    "repair.safe.confirm.title": "修复钉钉消息处理？",
    "repair.safe.deferred": "配置已修复。当前还有 %lld 个活动任务；任务结束后 OpenClaw 会自动重启。",
    "repair.safe.restartFailed": "配置已修复，但 OpenClaw 未能接受安全重启请求。",
    "repair.safe.scheduled": "配置已修复，网关已安全重启，钉钉连接正常。",
    "repair.safe.scheduledDingTalkPending": "配置已修复，网关已安全重启；钉钉尚未重新连接，请稍后检查渠道状态。",
    "repair.safe.upgradeRequired": "当前 OpenClaw %@ 不支持任务安全修复。请先升级到客户端内置核心 %@ 后重试；客户端不会修改核心代码。",
    "repair.safe.verificationFailed": "已请求安全重启，但未能确认网关恢复或配置生效。",
    "repair.step.deferralFailed": "无法将安全重启设置为无限期等待活动任务",
    "repair.step.deferralRepaired": "安全重启已设置为无限期等待活动任务",
    "repair.step.dmScopeFailed": "无法将私聊会话隔离设置为 per-channel-peer",
    "repair.step.dmScopeRepaired": "私聊会话隔离已设置为 per-channel-peer",
    ...
    "dashboard.session.action.unarchive": "取消归档",
    "dashboard.session.action.confirmDelete": "确认删除",
    "dashboard.session.newChat": "新会话",
    "dashboard.session.showMore": "还有 %@ 条…",
    "dashboard.session.filter.active": "活跃",
    "dashboard.session.filter.archived": "已归档",
    "dashboard.session.filter.all": "全部",
    "dashboard.session.filter.tooltip": "筛选会话",
    "dashboard.session.empty.active": "暂无会话",
    "dashboard.session.empty.archived": "没有已归档的会话",
    "dashboard.session.empty.all": "暂无会话",
    "dashboard.session.row.messageCount": "%lld 条消息",
    ...
    "dashboard.cron.sheet.session.conversation": "独立会话",
    "dashboard.cron.sheet.sessionHelp": "独立会话：每次运行写入同一条聊天。隔离：每次新建一次性会话。主会话：复用 Agent 主会话。",
    "dashboard.cron.openChat": "打开对话",
    "dashboard.cron.sessionTitle": "定时任务：%@",
...
COMMON_ZH_HANT = {
    ...
    "repair.action.safeRepair": "安全修復閘道",
    "repair.emergency.confirm.message": "安全修復未能完成。緊急修復會強制結束閘道處理程序，可能中斷執行中的任務；設定和聊天記錄會保留。",
    "repair.emergency.confirm.proceed": "執行緊急修復",
    "repair.emergency.confirm.title": "執行緊急修復？",
    "repair.safe.coalesced": "已有安全重新啟動要求正在等待（目前 %lld 個活動任務）。任務結束後 OpenClaw 會自動重新啟動。",
    "repair.safe.configurationFailed": "無法安全寫入並複核所需設定，尚未要求重新啟動。",
    "repair.safe.confirm.message": "將釘釘私聊改為按頻道和聯絡人隔離。若存在活動任務，OpenClaw 會等任務結束後再重新啟動。",
    "repair.safe.confirm.proceed": "開始安全修復",
    "repair.safe.confirm.title": "修復釘釘訊息處理？",
    "repair.safe.deferred": "設定已修復。目前還有 %lld 個活動任務；任務結束後 OpenClaw 會自動重新啟動。",
    "repair.safe.restartFailed": "設定已修復，但 OpenClaw 未能接受安全重新啟動要求。",
    "repair.safe.scheduled": "設定已修復，閘道已安全重新啟動，釘釘連線正常。",
    "repair.safe.scheduledDingTalkPending": "設定已修復，閘道已安全重新啟動；釘釘尚未重新連線，請稍後檢查頻道狀態。",
    "repair.safe.upgradeRequired": "目前 OpenClaw %@ 不支援任務安全修復。請先升級到客戶端內建核心 %@ 後重試；客戶端不會修改核心程式碼。",
    "repair.safe.verificationFailed": "已要求安全重新啟動，但未能確認閘道恢復或設定生效。",
    "repair.step.deferralFailed": "無法將安全重新啟動設為無限期等待活動任務",
    "repair.step.deferralRepaired": "安全重新啟動已設為無限期等待活動任務",
    "repair.step.dmScopeFailed": "無法將私聊工作階段隔離設為 per-channel-peer",
    "repair.step.dmScopeRepaired": "私聊工作階段隔離已設為 per-channel-peer",
    ...
    "dashboard.session.action.unarchive": "取消封存",
    "dashboard.session.action.confirmDelete": "確認刪除",
    "dashboard.session.newChat": "新會話",
    "dashboard.session.showMore": "還有 %@ 條…",
    "dashboard.session.filter.active": "使用中",
    "dashboard.session.filter.archived": "已封存",
    "dashboard.session.filter.all": "全部",
    "dashboard.session.filter.tooltip": "篩選會話",
    "dashboard.session.empty.active": "尚無會話",
    "dashboard.session.empty.archived": "沒有已封存的會話",
    "dashboard.session.empty.all": "尚無會話",
    "dashboard.session.row.messageCount": "%lld 則訊息",
    ...
    "dashboard.cron.sheet.session.conversation": "獨立會話",
    "dashboard.cron.sheet.sessionHelp": "獨立會話：每次執行寫入同一條聊天。隔離：每次新建一次性會話。主會話：重用 Agent 主會話。",
    "dashboard.cron.openChat": "開啟對話",
    "dashboard.cron.sessionTitle": "定時任務：%@",
