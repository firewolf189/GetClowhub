...
struct VerifyPluginCatalogService {
    static func main() throws {
        ...
        try write("plugins/All/alpha/.codex-plugin/plugin.json", """
        {
          "name": "alpha",
          "version": "1.0.0",
        ...
        """)
        try write("plugins/All/alpha/package.json", """
        {
        ...
        """)
        try write("plugins/All/alpha/openclaw.plugin.json", """
        { "id": "alpha", "configSchema": { "type": "object", "properties": {} } }
        """)
        try write("plugins/All/alpha/index.ts", "export default function() {}\n")
        try write("plugins/All/alpha/assets/icon.png", "not-a-real-png")

        try write("plugins/recommend/beta/.codex-plugin/plugin.json", """
        {
          "name": "beta",
          "version": "1.0.0",
        ...
        """)
        try write("plugins/recommend/beta/package.json", """
        {
        ...
        """)
        try write("plugins/recommend/beta/openclaw.plugin.json", "{ \"id\": \"beta\" }\n")
        try write("plugins/recommend/beta/index.ts", "export default function() {}\n")
        ...
        expect(alpha?.source == .all, "alpha should come from All")
        expect(beta?.source == .recommend, "beta should come from recommend")
        ...
        expect(command.contains("plugins/recommend/beta"), "install command should point at cached beta directory")
