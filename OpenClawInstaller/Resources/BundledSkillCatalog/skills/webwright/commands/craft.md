...
`commands/` folder) and the `references/cli_tool_mode.md` next to it,
...
Refer to `references/cli_tool_mode.md` for the complete contract and
`references/playwright_patterns.md` for the Playwright skeleton.
