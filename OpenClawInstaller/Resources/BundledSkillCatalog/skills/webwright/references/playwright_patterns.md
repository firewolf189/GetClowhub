...
These are the canonical heredoc patterns the Webwright agent uses. In
GetClowHub/OpenClaw, run them through the available shell command tool. Do not
wrap commands in JSON; use one shell command per turn.
