    ...
    private var sidebarTopHeader: some View {
        HStack(spacing: 8) {
            ...
            if sparkleUpdater.updateAvailable {
                ...
                .unifiedTooltip(UnifiedTooltipContent(
                    title: String(localized: "Check for Updates", bundle: LanguageManager.shared.localizedBundle),
                    detail: String(localized: "Look for the latest GetClawHub version", bundle: LanguageManager.shared.localizedBundle)
                ))
            }
