...
struct PluginDetailPresentationItem: Identifiable {
    ...
    static func fromInstalled(_ plugin: PluginInfo, catalogItem: PluginCatalogItem?) -> PluginDetailPresentationItem {
        ...
        let display = I18n.installedPluginDisplay(for: plugin, catalogItem: catalogItem)
...
struct PluginsTabView: View {
    ...
    @StateObject private var model: PluginListViewModel
    ...
    init(
        ...
        _model = StateObject(
            wrappedValue: PluginListViewModel(
                openclawService: openclawService,
...
private struct InstalledPluginFallbackDisplay {
    ...
    init(plugin: PluginInfo) {
        let display = I18n.installedPluginDisplay(for: plugin, catalogItem: nil)
        self.displayName = display.displayName
        self.description = display.description
        self.documentationMarkdown = display.longDescription
    }
}
...
struct InstallPluginSheet: View {
    @ObservedObject var model: PluginListViewModel
