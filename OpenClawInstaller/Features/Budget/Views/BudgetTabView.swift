...
struct AgentBudgetRow: View {
    ...
    var body: some View {
        HStack {
            ...
            .buttonStyle(.plain)
            .unifiedTooltip(UnifiedTooltipContent(title: I18n.t("budget.action.resetAgentSession", fallback: "Reset agent session")))
            .frame(width: 50)
            .onHover { hovering in
                isHovering = hovering
...
struct BudgetRuleRow: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            .buttonStyle(.plain)
            .unifiedTooltip(UnifiedTooltipContent(title: rule.enabled ? I18n.t("catalog.action.disable") : I18n.t("catalog.action.enable")))
            ...
            .buttonStyle(.plain)
            .unifiedTooltip(UnifiedTooltipContent(title: I18n.t("common.action.edit")))
            ...
            .buttonStyle(.plain)
            .unifiedTooltip(UnifiedTooltipContent(title: I18n.t("common.action.delete")))
        }
        .padding(.vertical, 6)
